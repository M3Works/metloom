#!/usr/bin/env python
#
# metloom documentation build configuration file, created by
...
version = metloom.__version__
# The full version, including alpha/beta/rc tags.
release = metloom.__version__
...
latex_documents = [
    (master_doc, 'metloom.tex',
     'metloom Documentation',
     'M3Works', 'manual'),
]

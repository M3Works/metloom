...
def test_merge_df():
    first = pd.DataFrame(
        {
            "datetime": [datetime(2020, 1, 3), datetime(2020, 1, 6), datetime(2020, 1, 7)],
            "a": [3.0, 6.0, 7.0],
            "c": [3.0, 6.0, 7.0]
        }
    ).set_index("datetime")
    second = pd.DataFrame(
        {
            "datetime": [datetime(2020, 1, 2), datetime(2020, 1, 5),
    ...
    expected = pd.DataFrame(
        {
            "datetime": [datetime(2020, 1, 2), datetime(2020, 1, 3), datetime(2020, 1, 5),
